...
<template>
  <div class="main-container">
    ...
    <footer class="footer">{{ session.note }} Licznik akcji: {{ session.useCounter }}</footer>
  </div>
</template>
